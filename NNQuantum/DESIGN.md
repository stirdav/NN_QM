...
Elaborates the Step 1 sub-points from `CLAUDE.md`'s Plan section: rewriting the HBAR-qubit problem on `QuantumDynamics`, scoped to the `:FL_1step_3p` variant only. This is design-stage detail, not implementation — nothing here has been coded yet.
