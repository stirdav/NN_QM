...
#
# Run from NNQuantum/test/ (REPL: include("test.jl"), or `julia test.jl`).
# Activates the examples/ environment (../examples/Project.toml) since this
# folder has no Project.toml of its own — see the file-layout note at the
# top of CLAUDE.md.
...
include("../examples/FockLadder_execution.jl")     # :FL_1step_3p — includes Definition.jl, NNQuantum.jl,
                                         # FockLadder_problem.jl; gives sections 1-4 below
                                         # cs/H0/J/FLstep_dynamics_3p/_inputs/_outputs/
                                         # run_Fock_ladder etc.
include("../examples/Bspline_Fock_execution.jl")   # :FL_1step_Bspline (DESIGN.md Part 19) — its own,
